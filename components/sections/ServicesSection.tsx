...
export default function ServicesSection() {
  ...
  const fiverrGigs = [
    {
      ...
      description: "Custom web applications with Next.js, React, and modern technologies",
      url: "https://www.fiverr.com/s/XLAXkPm",
      price: "Starting at $500",
      platform: "Fiverr",
    },
    {
      title: "AI Integration & Automation",
      description: "Integrate AI models, chatbots, and automation into your applications",
      url: "https://www.fiverr.com/s/6YGzdmN",
      price: "Starting at $400",
      platform: "Fiverr",
    },
    {
      title: "SaaS Development",
      description: "Complete SaaS platform development with authentication and payment integration",
      url: "https://www.fiverr.com/s/xXNk5YB",
  ...
  const upworkServices = [
    {
      title: "Stripe Subscriptions & Webhooks Integration",
      description:
        "Complete Stripe payment integration with subscription management and webhook handling",
    ...
    {
      title: "SaaS MVP: Next.js + FastAPI + PostgreSQL",
      description: "Full-stack SaaS development with authentication, database, and deployment",
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-muted-foreground mt-4 text-lg">
            Ready-to-book services on Fiverr and Upwork
          </p>
        </motion.div>
        ...
        <div className="mb-16">
          ...
          >
            ...
            <h3 className="text-foreground text-2xl font-bold">Fiverr Services</h3>
          </motion.div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {fiverrGigs.map((gig, index) => (
              ...
              >
                ...
                <p className="text-muted-foreground mb-4 line-clamp-2 text-sm">{gig.description}</p>

                <div className="flex items-center justify-between">
                  <span className="text-primary text-sm font-medium">{gig.price}</span>
        ...
        <div>
          ...
          >
            ...
            <h3 className="text-foreground text-2xl font-bold">Upwork Services</h3>
          </motion.div>

          <div className="grid gap-6 md:grid-cols-2">
            {upworkServices.map((service, index) => (
              <motion.a
                key={service.url}
                href={service.url}
                target="_blank"
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="text-primary text-sm font-medium">{service.price}</span>
                  <span className="text-muted-foreground group-hover:text-foreground text-xs transition-colors">
                    View Details →
                  </span>
                </div>
