    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mt-4 text-lg" style={{ color: "var(--t-secondary)" }}>
            {t("services_pro.subtitle")}
          </p>
        </motion.div>
        ...
        <div className="mb-16">
          ...
          >
            ...
            <h3 className="text-2xl font-bold" style={{ color: "var(--t-primary)" }}>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {FIVERR_GIGS.map((gig, index) => (
              ...
              >
                ...
                <p className="mb-4 line-clamp-2 text-sm" style={{ color: "var(--t-secondary)" }}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs transition-colors" style={{ color: "var(--t-muted)" }}>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {UPWORK_SERVICES.map((service, index) => (
              ...
              >
                ...
                <p className="mb-4 text-sm" style={{ color: "var(--t-secondary)" }}>
